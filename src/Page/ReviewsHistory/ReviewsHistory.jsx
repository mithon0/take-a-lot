...
const ReviewsHistory = () => {
    return (
      ...
      <ul className='flex gap-5 ms-5 text-black'>
            <NavLink to="/account/reviews" className={({ isActive }) => (isActive ? " text-black text-xs border-b-4 border-blue-500 py-2" : "hover:text-blue-500 pl-10 py-2  rounded-r-full bg-opacity-10 border-b-4 border-transparent text-xs black")}>Order Items</NavLink>
